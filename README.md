...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-6mpyzbm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-6mpyzbm.containers.anotherwebservice.com/
...
```
git clone git@github.com:thienphong0/container-6mpyzbm.git
cd container-6mpyzbm
```
...
```
docker attach container-6mpyzbm
```
